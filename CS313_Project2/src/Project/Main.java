...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (flag) {
            System.out.println("*** OPTIONS 1, 2, 3 are for PROJECT 1");
            System.out.println("\nMAIN MENU:");
            System.out.println("1) CREATE NEW LIST");
            System.out.println("2) IMPORT LIST");
            System.out.println("3) IMPORT DEMO LIST");
            System.out.println("4) IMPORT FINAL ROSTER");
            ...
            //Project 2
                ...
                Scanner scanner = new Scanner(new File("B:\\IdeaProjects\\WarmUpProject\\src\\Project\\output.csv"));
                Scanner valueScanner = null;
                int index = 0;
                boolean flag4 = true;
                ...
                while (scanner.hasNextLine()) {
                    ...
                    else System.out.println("ROSTER FULL - MAX SIZE 10");
